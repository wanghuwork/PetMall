...
from user.models import UserInfo, AddressManager
...
class UserInfoView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        user = request.user
        # 地址
        address = AddressManager.objects.get_default_address(user)
        # 浏览记录
...
class UserOrderView(LoginRequiredMixin, View):
    def get(self, request, page):
        ...
        for order in orders:
            ...
            order.status_name = OrderInfo.ORDER_STAYUS[order.order_status]
...
class AddressView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        # 添加地址
        AddressManager.objects.create(user=user,
                                      recipients=receiver,
                               address=addr,
                               postcode=postcode,
                               rphone=phone,
